...
public class Chalan_Report_Summary_Model {
    String chalanItem_name;
    String chalanSell_qty;
    String chalanMu_name;
    String chalan_amount;

    public Chalan_Report_Summary_Model(String chalanItem_name, String chalanSell_qty, String chalanMu_name, String chalan_amount) {
