...
public class MyTeamsAttendance_Model {
    String person_no;
    String emp_name;
    String designation;
    String departmetn;
    ...
    public MyTeamsAttendance_Model(String person_no, String emp_name, String designation, String departmetn, String loginTime, String late_logInReason, String logoutTime, String early_logOutReason, String absent_Resason, String weekend, String holiday, String lateLogin_Flag, String earlyLogOut_Flag) {
