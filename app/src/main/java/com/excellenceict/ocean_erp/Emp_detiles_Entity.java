...
public class Emp_detiles_Entity {
    String person_id;
    String emp_name;
    String desig_dept;
    String reporters_to;
    ...
    public Emp_detiles_Entity(String person_id, String emp_name, String desig_dept, String reporters_to, String phone_mobile, String phone_home, String email_personal, String email_official, String address1, String join_date, String pabx, String blood_grp) {
