...
public class View_Voucher_Result_Entity {
    String date;
    String voucher;
    String ref;
    String tr_type;
    ...
    public View_Voucher_Result_Entity(String date, String voucher, String ref, String tr_type, String amount, String note, String totalVoucher_amount) {
        this.date = date;
