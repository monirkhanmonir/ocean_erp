...
public class EmpInfo_Activity extends AppCompatActivity implements CustomEmpInfoAdapter.SelectedEmployee {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.emp_info_activity);
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                EmpInfo_Activity.this.adapter.getFilter().filter(newText);
                return false;
            }
        });
    ...
    private class Emp_info_Task extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                busyDialog.dismis();
                Toast.makeText(EmpInfo_Activity.this, "" + e,Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(Void aVoid) {
            busyDialog.dismis();
            empView.setLayoutManager(new LinearLayoutManager(EmpInfo_Activity.this));
            empView.addItemDecoration(new DividerItemDecoration(EmpInfo_Activity.this,DividerItemDecoration.VERTICAL));
            adapter = new CustomEmpInfoAdapter(empInfoItems, (CustomEmpInfoAdapter.SelectedEmployee) EmpInfo_Activity.this);
