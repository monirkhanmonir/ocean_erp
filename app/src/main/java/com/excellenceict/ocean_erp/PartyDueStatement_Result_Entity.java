...
public class PartyDueStatement_Result_Entity {
    String ud_no;
    ...
    public PartyDueStatement_Result_Entity(String ud_no, String sub_header_name, String analyzer, String roche, String sysmex) {
        this.ud_no = ud_no;
